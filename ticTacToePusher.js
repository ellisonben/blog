(function() {
    ...
    function broadcastMove(move) {
        console.log("broadcasting move", channel, move);
        channel.trigger("client-move", move);
    }
    ...
    document.getElementById("newGame").addEventListener("click", function() {
        newGame();
        channel.trigger("client-newGame", {});
    });
    ...
    var pusher = new Pusher('f4ab4f243219fbf58dcf', {
        encrypted: true
        
    });

    var channel = pusher.subscribe('private-tictactoe');
    channel.bind('client-move', function(move) {
        makeMove(move);
    });
    channel.bind('client-newGame', function() {
        newGame();
    });
